...
import CoreLocation
import MapKit
class DetailedFlightViewController: UITableViewController, CLLocationManagerDelegate {
    ...
    override func viewDidLoad() {
        ...
        spinner.addTarget(self, action: #selector(DetailedFlightViewController.getFlightData), for: .valueChanged)
    ...
    func getFlightData(){
        ...
        let depUrl = updateDepartingFlight(flight.airlineCode!, airlineNumber: flight.flightNumber!,date: flight.arrivalMonthDayYear!)
        
        getLatestDepartingInfo(depUrl)
        
        let arrivalUrl = updateArrivalFlight(flight.airlineCode!, airlineNumber: flight.flightNumber!,date: flight.arrivalMonthDayYear!)
